...
func(m *DBModel) UpdateMovie(movie Movie) error{
	...
	statement := `update movies set title = $1, description = $2, year = $3, 
                  release_date = $4, runtime = $5, rating = $6, mpaa_rating = $7,
...
func(m *DBModel) InsertMovie(movie Movie) error{
	...
	statement := `insert into movies(title, description, year, release_date, runtime, rating, mpaa_rating,created_at, updated_at) values($1, $2, $3, $4, $5, $6, $7, $8, $9)`
